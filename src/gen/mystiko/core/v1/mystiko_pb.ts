...
export class MystikoOptions extends Message<MystikoOptions> {
  ...
  /**
   * @generated from field: optional mystiko.loader.v1.LoaderConfig loader_config = 2;
   */
  loaderConfig?: LoaderConfig;

  /**
   * @generated from field: optional string db_path = 3;
   */
  dbPath?: string;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: 'loader_config', kind: 'message', T: LoaderConfig, opt: true },
    { no: 3, name: 'db_path', kind: 'scalar', T: 9 /* ScalarType.STRING */, opt: true },
  ]);
