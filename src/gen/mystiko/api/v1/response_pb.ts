...
export class StatusCode extends Message<StatusCode> {
  ...
  error:
    ...
    | {
        /**
         * @generated from field: mystiko.api.v1.AccountError account = 3;
         */
        value: AccountError;
        case: 'account';
      }
    | {
        /**
         * @generated from field: mystiko.api.v1.DepositError deposit = 4;
         */
        value: DepositError;
        case: 'deposit';
      }
    | {
        /**
         * @generated from field: mystiko.api.v1.ScannerError scanner = 5;
         */
        value: ScannerError;
        case: 'scanner';
      }
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: 'account', kind: 'enum', T: proto3.getEnumType(AccountError), oneof: 'error' },
    { no: 4, name: 'deposit', kind: 'enum', T: proto3.getEnumType(DepositError), oneof: 'error' },
    { no: 5, name: 'scanner', kind: 'enum', T: proto3.getEnumType(ScannerError), oneof: 'error' },
  ]);
