...
import { ResetOptions } from '../../../core/synchronizer/v1/reset_pb.js';
...
/**
 * @generated from message mystiko.api.synchronizer.v1.ResetRequest
 */
export class ResetRequest extends Message<ResetRequest> {
  /**
   * @generated from field: mystiko.core.synchronizer.v1.ResetOptions options = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = 'mystiko.api.synchronizer.v1.ResetRequest';
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: 'options', kind: 'message', T: ResetOptions },
  ]);
  ...
  static equals(
    a: ResetRequest | PlainMessage<ResetRequest> | undefined,
    b: ResetRequest | PlainMessage<ResetRequest> | undefined,
  ): boolean {
