...
import { ResetOptions } from '../../../core/scanner/v1/reset_pb.js';
...
/**
 * @generated from message mystiko.api.scanner.v1.ResetRequest
 */
export class ResetRequest extends Message<ResetRequest> {
  /**
   * @generated from field: mystiko.core.scanner.v1.ResetOptions options = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = 'mystiko.api.scanner.v1.ResetRequest';
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
