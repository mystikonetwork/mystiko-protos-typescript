 ...
 */
export class SupportedAssetSymbolsResponse extends Message<SupportedAssetSymbolsResponse> {
  /**
   * @generated from field: repeated string symbols = 1;
   */
  symbols: string[] = [];

  constructor(data?: PartialMessage<SupportedAssetSymbolsResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = 'mystiko.api.config.v1.SupportedAssetSymbolsResponse';
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: 'symbols', kind: 'scalar', T: 9 /* ScalarType.STRING */, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SupportedAssetSymbolsResponse {
    return new SupportedAssetSymbolsResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SupportedAssetSymbolsResponse {
    return new SupportedAssetSymbolsResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(
    jsonString: string,
    options?: Partial<JsonReadOptions>,
  ): SupportedAssetSymbolsResponse {
    return new SupportedAssetSymbolsResponse().fromJsonString(jsonString, options);
  }

  static equals(
    a: SupportedAssetSymbolsResponse | PlainMessage<SupportedAssetSymbolsResponse> | undefined,
    b: SupportedAssetSymbolsResponse | PlainMessage<SupportedAssetSymbolsResponse> | undefined,
  ): boolean {
    return proto3.util.equals(SupportedAssetSymbolsResponse, a, b);
  }
}
