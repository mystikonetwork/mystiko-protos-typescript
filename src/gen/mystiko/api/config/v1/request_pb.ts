 ...
 */
export class SupportedAssetSymbolsRequest extends Message<SupportedAssetSymbolsRequest> {
  /**
   * @generated from field: uint64 chain_id = 1;
   */
  chainId = protoInt64.zero;

  constructor(data?: PartialMessage<SupportedAssetSymbolsRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = 'mystiko.api.config.v1.SupportedAssetSymbolsRequest';
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: 'chain_id', kind: 'scalar', T: 4 /* ScalarType.UINT64 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SupportedAssetSymbolsRequest {
    return new SupportedAssetSymbolsRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SupportedAssetSymbolsRequest {
    return new SupportedAssetSymbolsRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(
    jsonString: string,
    options?: Partial<JsonReadOptions>,
  ): SupportedAssetSymbolsRequest {
    return new SupportedAssetSymbolsRequest().fromJsonString(jsonString, options);
  }

  static equals(
    a: SupportedAssetSymbolsRequest | PlainMessage<SupportedAssetSymbolsRequest> | undefined,
    b: SupportedAssetSymbolsRequest | PlainMessage<SupportedAssetSymbolsRequest> | undefined,
  ): boolean {
    return proto3.util.equals(SupportedAssetSymbolsRequest, a, b);
  }
}
